...
(function(window,document,Laya){
	...
	*@author ww
	*/
	//class demo.TransformLearningDemo extends demo.DemoBase
	var TransformLearningDemo=(function(_super){
		function TransformLearningDemo(){
			this.modelO=null;
			TransformLearningDemo.__super.call(this);
			this.useVideo=true;
		}

		__class(TransformLearningDemo,'demo.TransformLearningDemo',_super);
		var __proto=TransformLearningDemo.prototype;
		__proto.initModels=function(){
			var path;
	...
	*/
	...
	new demo.TransformLearningDemo();
