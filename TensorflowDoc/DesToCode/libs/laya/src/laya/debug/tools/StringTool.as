...
//			trace(rst+" "+rst.length);
		...
		public static function getStringTemplate(str:String,leftSign:String,rightSign:String):Array
		{
			var rst:Array;
			rst=[];
			var preI:int;
		...
		public static function getPairBetweens(str:String, left:String, right:String):Array
		{
			var rst:Array=[];
			if(!str) return rst;
			if(!left) return rst;
		...
		public static function replaceWraped(str:String, left:String, right:String,newStr:String):String
		{
			var pairs:Array;
			pairs = getPairBetweens(str, left, right);
			if (!pairs) return str;
			var i:int, len:int;
			len = pairs.length;
			var tPair:Object;
		...
		public static function getBetweenWithWrap(str:String, left:String, right:String, ifMax:Boolean = false):String
		{
			var bt:String;
			bt = getBetween(str, left, right, ifMax);
			return left + bt + right;
		}
		
		public static function replaceBetween(str:String, left:String, right:String, ifMax:Boolean = false, newStr:String=""):String
		{
			var bt:String;
			bt = getBetween(str, left, right, ifMax);
			var rst:String;
		...
		public static function replaceBetweenEx(str:String, left:String, right:String, ifMax:Boolean = false, newStr:String=""):String
		{
			var bt:String;
			bt = getBetween(str, left, right, ifMax);
			var rst:String;
