...
package laya.debug.tools
{
	...
	public class ObjectTools
	{
		...
		public static function isObjectClass(obj:Object,classStr:String):Boolean
		{
			if(!obj.constructor||!obj.constructor.name) return false;
			return obj.constructor.name==classStr;
		}
		
		public static function copyObj(obj:Object):Object
		{
			
			if(isObjectClass(obj,"Array")) return copyArr(obj as Array);
			if(!(obj is Object))
			{
				return obj;
			}
			...
			for(key in obj)
			{
				...
				if(isObjectClass(obj[key],"Array"))
				{
