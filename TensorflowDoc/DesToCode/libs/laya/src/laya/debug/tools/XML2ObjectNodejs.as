	...
	public class XML2ObjectNodejs {
		...
		public static function parse(node:*,isFirst:Boolean=true):Object {
			...
			for(var i:int = 0; i<numOfChilds; i++) {
				var childNode:* = node[ChildrenSign][i];
