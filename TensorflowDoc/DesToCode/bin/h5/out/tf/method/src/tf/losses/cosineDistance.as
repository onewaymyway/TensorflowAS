...
package tf.losses
{
	 ...
	 * @param axis (number) The dimension along which the cosine distance is computed.
	 ...
	 * @return tf.Tensor
	 */
	public function cosineDistance(labels:*=null,predictions:*=null,axis:*=null,weights:*=null,reduction:*=null):*
	{
		return ;
	}
